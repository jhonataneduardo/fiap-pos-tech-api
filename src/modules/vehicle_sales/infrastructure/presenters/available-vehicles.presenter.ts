...
/**
 * AvailableVehiclesPresenter
 *
 * Responsável por formatar a saída do caso de uso FindAvailableVehiclesUseCase
...
export class AvailableVehiclesPresenter {
    /**
     * Formata o resultado do use case (array de vehicles disponíveis) para view model HTTP
     */
