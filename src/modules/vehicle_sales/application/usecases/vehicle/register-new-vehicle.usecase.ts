...
import { InputVehicleDTO, OutputVehicleDTO } from "@/modules/vehicle_sales/application/dtos/vehicle.dto";
import { VehicleEntityFactory } from "@/modules/vehicle_sales/domain/entities/vehicle.entity";
